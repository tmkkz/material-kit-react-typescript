...
import CustomLinearProgress from "ui.components/CustomLinearProgress/CustomLinearProgress";
import Paginations from "ui.components/Pagination/Pagination";
...
const SectionBasics = (): ReactElement => {
        ...
        <div id="progress">
          <GridContainer>
            ...
            <GridItem xs={12} sm={12} md={6}>
              ...
              <Paginations count={12} siblingCount={2} page={7} />
              <Paginations
                count={5}
                previousText="PREV"
                nextText="NEXT"
